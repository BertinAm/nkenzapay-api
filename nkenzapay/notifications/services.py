...
CATALOGUE = {
    ...
    "account.id_rejected": ("We could not approve that document",
                            "{detail}",
                            "error", "retry_upload", "danger", True),
    "account.verification_reminder": ("Finish setting up your account",
                                      "{detail}",
                                      "pending_actions", "finish_setup", "warn", True),
    "admin.id_submitted": ("{customer} submitted an identity document",
                           "Waiting on the desk to check it.",
                           "how_to_reg", "review", "warn", True),
    ...
    "admin.transfer_cancelled": ("Transfer cancelled",
                                 "{who} cancelled {reference} for {send_amount}.",
                                 "close", "view", "neutral", True),
